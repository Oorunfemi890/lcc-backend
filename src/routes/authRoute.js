// routes/auth.js - Fixed with better validation
...
// FIXED: Removed strict phone validation, just check if it exists
...
router.post(
  ...
  authenticateToken,
  requestProfileUpdateValidation,
  logActivity("request_profile_update"),
...
router.post(
  ...
  authController.verifyProfileToken
);
...
router.post(
  ...
  logActivity("request_password_change"),
